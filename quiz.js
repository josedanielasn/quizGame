...
function person(question, choices, answer) {
  // this.number = number;
...
// function selected() {
//   if (this.choices.indexOf(this.answer) )
//   document.addEventListener('keypress', function (e) {
//     if (e.keycode === 49) console.log('true');
//   });
// }

function list_questions() {
  let num_1 = new person(
    // 1,
    'What is the biggest planet in our solar system?',
    ['Earth', 'Jupiter', 'Saturn', 'Uranus'],
    'Jupiter'
  );
  let num_2 = new person(
    // 2,
